...
tx_weather_ffill = pd.merge_ordered(austin, houston, on='date', suffixes=[
                                    '_aus', '_hus'], fill_method='ffill')
...
yearly = merged.resample('A', on='Date')
yearly = yearly[['mpg', 'Price']].mean()
